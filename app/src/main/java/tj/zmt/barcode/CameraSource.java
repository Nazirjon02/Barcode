...
public class CameraSource {
    ...
    private class FrameProcessingRunnable implements Runnable {
        ...
        @SuppressLint("Assert")
        void release() {
            // If camera was never started, processing thread may be null.
            Thread processingThread = mProcessingThread;
            if (processingThread == null || processingThread.getState() == State.TERMINATED) {
                // safe to release
            }
            if (mDetector != null) {
                mDetector.release();
